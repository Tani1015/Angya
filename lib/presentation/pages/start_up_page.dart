  ...
  Widget build(BuildContext context, WidgetRef ref) {
    useEffectOnce(() {
      Future(() async {
        ...
        final localEmail = localdb.fetch<String>(SharedPreferencesKey.email);
        final localPass = localdb.fetch<String>(SharedPreferencesKey.password);
        if (localEmail != null && localPass != null) {
          await ref
              .read(signInWithEmailAndPasswordProvider)
              .call(localEmail, localPass);
        }
